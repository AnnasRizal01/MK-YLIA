                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/documentation/react/build/toasts" target="_blank">
                        ...
                        <div className="d-flex justify-content-end">
                            <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider">
                                <Nav.Item as="li" role="presentation">
                                    <Nav.Link as="button" eventKey="first" className={toggleState === true ? "tabs active" : "tabs d-flex align-items-center"} onClick={() => setToggleState(true)} data-bs-toggle="tab" data-bs-target="#content-Toasts-prv" type="button" role="tab" aria-controls="output" aria-selected="true">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Nav.Item as="li" role="presentation">
                                    <Nav.Link as="button" eventKey="second" className={toggleState === false ? "tabs active-tabs" : "tabs d-flex align-items-center"} onClick={() => setToggleState(false)} data-bs-toggle="tab" data-bs-target="#content-Toasts-code" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <Tab.Content>
                                <Tab.Pane eventKey="first" className={toggleState === true ? "content  active-content" : "content"} id="content-Toasts-prv" role="tabpanel" aria-labelledby="typo-output">
                                    <div className="bd-example bg-dark p-5 align-items-center">
                                        <Toast role="alert" aria-live="assertive" aria-atomic="true"  onClose={() => setShowA(false)} show={showA} >
                                            <Toast.Header>
                                    ...
                                    <div className="bd-example bg-dark p-5 align-items-center">
                                        <Toast className="align-items-center" role="alert" aria-live="assertive" aria-atomic="true" onClick={() =>setShowB(false)} show={showB}>
                                    ...
                                    <div className="bd-example bg-dark p-5 align-items-center">
                                        <Toast className=" fade show" role="alert" aria-live="assertive" aria-atomic="true" show={showC}>
                                            <Toast.Body>
                                                Hello, world! This is a toast message.
                                                <div className="mt-2 pt-2 border-top">
                                                <Button type="button" variant="primary">Take action</Button>{' '}
                                                <Button type="button" variant="dark" data-bs-dismiss="toast" onClick={toggleShowC}>Close</Button>
                                                </div>
                                            </Toast.Body>
                                        </Toast>
                                    </div>
