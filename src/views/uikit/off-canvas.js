...
import {Button, Offcanvas, Nav, Tab} from 'react-bootstrap'
            ...
            <article id="off-canvas">
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/documentation/react/build/offcanvas" target="_blank">
                ...
                <Card className=" iq-document-card">
                    <Tab.Container  defaultActiveKey="first">
                        ...
                        <Tab.Content>
                            <Tab.Pane eventKey="first" className={toggleState === 1 ? "content  active-content" : "content"} id="content-Offcanvas-prv" role="tabpanel" aria-labelledby="typo-output">
